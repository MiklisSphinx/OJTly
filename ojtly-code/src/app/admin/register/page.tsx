...
export default function AdminRegister() {
  ...
  // ==========================================
  // FORM STATE - Capturing username, password, masterKey
  // ==========================================
  ...
  // ==========================================
  // ✅ HANDLE REGISTER ADMIN FUNCTION
  // Following Z's instructions EXACTLY:
  // ==========================================
  const handleRegisterAdmin = async () => {
    ...
    // ==========================================
    // SECURITY: Check Master Key FIRST
    // Use process.env.NEXT_PUBLIC_ADMIN_MASTER_KEY
    // If wrong → DO NOT call Supabase Auth!
    // ==========================================
    ...
    try {
      // ==========================================
      // THE AUTH FUNCTION: supabase.auth.signUp
      // Create the account
      // ==========================================
      ...
      // ==========================================
      // CRITICAL: Immediately elevate permissions
      // Update profiles table with role: 'admin' AND is_approved: true
      // ==========================================
      if (authData.user) {
        ...
        if (profileError) {
          ...
          alert("Auth created, but role assignment failed. Contact admin.");
        } else {
          // ==========================================
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-black/30 border border-zinc-700 rounded-lg text-white focus:ring-1 focus:ring-red-500 focus:border-red-500 outline-none transition placeholder-zinc-600" 
                      required 
                    />
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 p-3 bg-red-500/5 border border-red-500/10 rounded-lg text-left">
                 ...
                 <p className="text-xs text-zinc-400">
                    <span className="font-semibold text-red-400">Security:</span> Requires valid authorization key. All actions are logged.
                 </p>
              </div>
              ...
              <button 
                type="submit" 
                disabled={isLoading}
                className={`w-full py-3.5 bg-red-600 text-white font-semibold rounded-lg shadow-lg shadow-red-900/20 hover:bg-red-500 hover:shadow-red-500/20 transition-all duration-300 mt-2 border border-red-500/50 flex items-center justify-center gap-2 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
                {isLoading ? (
                  <>
                  ...
                  <>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-4a3 3 0 01-3-3H5a3 3 0 00-3 3v6a3 3 0 003 3h6a3 3 0 013-3V7z" />
                    </svg>
