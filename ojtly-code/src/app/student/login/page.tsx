...
export default function UserLogin() {
  ...
  // Optional: State for inputs (good practice to control inputs)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Here you would normally check if email/password are correct
    // For now, we just redirect to the jobs page
    console.log("Logging in...");
    
    // Redirect to Job Board
    router.push('/student_main'); // 4. Use router to navigate to the student main page
  };
        ...
        <div className="relative z-10 text-center text-white p-8">
          <div className="mb-6">
            <div className="w-20 h-20 bg-white/20 backdrop-blur-lg rounded-2xl flex items-center justify-center mx-auto shadow-xl border border-white/30">
              <span className="text-4xl font-bold">OJ</span>
            </div>
          </div>
          <h1 className="text-4xl font-bold mb-4">Welcome to OJtly</h1>
        ...
        <div className="w-full max-w-md space-y-8 mt-12 lg:mt-0">
          ...
          <div className="flex justify-center">
            <div className="bg-gray-200/60 p-1 rounded-full flex gap-1 backdrop-blur-sm">
              <Link href="/student/login" className="px-6 py-2 rounded-full bg-white shadow-sm text-blue-600 font-medium text-sm transition-all">User</Link>
              <Link href="/company/login" className="px-6 py-2 rounded-full text-gray-600 font-medium text-sm hover:bg-white/50 transition-all">Company</Link>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl shadow-gray-200/40 border border-gray-100">
            {/* 4. Attach the handleSubmit function here */}
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition" 
                    required 
                    value={email}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-12 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition" 
                    required 
                    value={password}
              ...
              <button type="submit" className="w-full py-3.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
                Sign In
              </button>
